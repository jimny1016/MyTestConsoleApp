namespace MyTestConsoleApp.MyTestClass
{
    ...
    public partial class Win32
    {
        ...
        public struct MINMAXINFO
        {
            ...
            /// Reserved; do not use.
            /// </summary>
            public readonly POINT Reserved;
        ...
        , System.IComparable<int>
        {
            ...
            ///<summary>
            ///The certificate does not have a property that references a public key.
            ///</summary>
            [Description("The certificate does not have a property that references a public key.")]
            public const int CRYPT_E_UNEXPECTED_MSG_TYPE = unchecked((int)0x8009200A);

            ///<summary>
            ///Cannot find the certificate and public key for decryption.
            ///</summary>
            [Description("Cannot find the certificate and public key for decryption.")]
            public const int CRYPT_E_NO_KEY_PROPERTY = unchecked((int)0x8009200B);

            ///<summary>
            ///Cannot find the certificate and public key to use for decryption.
            ///</summary>
            [Description("Cannot find the certificate and public key to use for decryption.")]
            ...
            ///<summary>
            ///Cannot archive public key.  The certification authority is not configured for key archival.
            ///</summary>
            [Description("Cannot archive public key.  The certification authority is not configured for key archival.")]
            public const int CERTSRV_E_KEY_ARCHIVAL_NOT_CONFIGURED = unchecked((int)0x8009400A);

            ///<summary>
            ///Cannot archive public key.  The certification authority could not verify one or more key recovery certificates.
            ///</summary>
            [Description("Cannot archive public key.  The certification authority could not verify one or more key recovery certificates.")]
            public const int CERTSRV_E_NO_VALID_KRA = unchecked((int)0x8009400B);

            ///<summary>
            ///The request is incorrectly formatted.  The encrypted public key must be in an unauthenticated attribute in an outermost signature.
            ///</summary>
            [Description("The request is incorrectly formatted.  The encrypted public key must be in an unauthenticated attribute in an outermost signature.")]
            ...
            ///<summary>
            ///The request is missing a required public key for archival by the server.
            ///</summary>
            [Description("The request is missing a required public key for archival by the server.")]
            ...
            ///<summary>
            ///The request includes a public key for archival by the server, but key archival is not enabled for the specified certificate template.
            ///</summary>
            [Description("The request includes a public key for archival by the server, but key archival is not enabled for the specified certificate template.")]
            ...
            ///<summary>
            ///A public component cannot be moved (or copied) to a library application or to the base partition
            ///</summary>
            [Description("A public component cannot be moved (or copied) to a library application or to the base partition")]
            public const int COMADMIN_E_COMP_MOVE_public = unchecked((int)0x8011081E);
            ...
            ///<summary>
            ///Access is denied because the component is public.
            ///</summary>
            [Description("Access is denied because the component is public.")]
            public const int COMADMIN_E_public_ACCESSDENIED = unchecked((int)0x80110821);
